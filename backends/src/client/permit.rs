...
impl Client {
    ...
    // pub async fn create_organization(&self, user_id: &str, org_name: &str) -> Result<()> {
    //     self.api
    //         .post(
    ...
    // pub async fn get_organizations(&self, user_id: &str) -> Result<()> {
    //     self.api
    //         .get(
    //             &format!(
    ...
    //     &self,
    //     org_name: &str,
    // ) -> Result<Vec<OrganizationResource>> {
    //     self.api
    //         .get(
    //             &format!(
