...
impl Permit {
    ...
    fn endpoint(&self, base: &str, rest: &str) -> String {
        format!("/v2/{}/{}/{}/{}", base, self.proj_id, self.env_id, rest)
    }
    fn resource_instances(&self) -> String {
        self.endpoint("facts", "resource_instances")
    }
    fn role_assignments(&self) -> String {
        self.endpoint("facts", "role_assignments")
    }
