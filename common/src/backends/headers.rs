...
pub static X_SHUTTLE_PROJECT_ID: HeaderName = HeaderName::from_static("x-shuttle-project-id");
pub struct XShuttleProjectId(pub String);

impl Header for XShuttleProjectId {
    fn name() -> &'static HeaderName {
        &X_SHUTTLE_PROJECT_ID
    }
