...
/// TODO: use `super::states::DeploymentState`
...
/// This visitor is meant to extract the `ScopeDetails` for any scope with `id` and `status` fields
#[derive(Default)]
...
impl NewStateVisitor {
    /// Field containing the deployment id identifier
