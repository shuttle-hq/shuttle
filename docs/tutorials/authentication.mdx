...
[infrastructure from code design](https://www.shuttle.rs/blog/2022/05/09/ifc).
...
[pbkdf2](https://crates.io/crates/pbkdf2)(cargo add pbkdf2):
...
[ChaCha](https://crates.io/crates/rand_chacha) algorithm/crate (we will add
...
newly signed-up user. We post it to the table with our `user_id`
...
[new type pattern](https://www.shuttle.rs/blog/2022/07/28/patterns-with-rust-types#the-new-type-pattern)over
...
[You can read more about it in more detail there](https://www.shuttle.rs/blog/2022/08/04/middleware).
...
[signup section](https://docs.shuttle.rs/guide/authentication-tutorial.html#using-html-forms)
