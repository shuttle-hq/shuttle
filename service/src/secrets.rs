...
#[async_trait]
pub trait SecretStore<DB, Arguments>
where
    DB: Database<Arguments = Arguments>,
    Arguments: for<'q> IntoArguments<'q, DB>,
...
#[async_trait]
impl SecretStore<sqlx::Postgres, sqlx::postgres::PgArguments> for sqlx::PgPool {
