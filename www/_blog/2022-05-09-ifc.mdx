...
Our team at shuttle is extremely passionate about leverage through software. We want to empower engineers by creating the best possible developer experience.

We've already developed and deployed an annotation based system that enables Rust apps to be deployed with a one-liner, as well as dependencies like databases being provisioned through static analysis in real-time.
