...
This is great, we now have a full authenticated site. But we have no users, our friends can't log in on our localhost. We want to put it on the interwebs and with our set up shuttle service main function set up it is easy.
