...
# Announcing shuttle beta - Replacing containers for backend development
...
>
> We're announcing shuttle-next: a next-generation backend development framework that has **up to 100x smaller images** and **deploys end-to-end in under a second**.
...
We are launching `shuttle-next` as part of our closed beta for `shuttle` later this month, with the public release coming soon after. If you’re keen to give it a try early, **sign up for the beta!**
